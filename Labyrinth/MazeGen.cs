...
namespace Labyrinth
{
    class MazeGen
    {
        ////This is the algorithm or the Recursive Backtracker.

        //    public MazePrim(List<List<Node>> nodes) : base(nodes)
        //    {
        //    }
        ...
        //    public MazePrim(int width, int height) : base(width, height)
        //    {
        //    }
